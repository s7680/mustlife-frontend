              ...
              {user &&
                ...
                activeProfileAttempt.user_id === user.id && (
                  <div className="flex flex-col gap-2">
                    <button
                      className="text-xs text-red-600 underline cursor-pointer hover:text-red-700 transition"
                    ...
                    {!isReAttempt && (
                      <button
                        className="border px-4 py-2 rounded text-sm w-fit"
                        onClick={() => {
                          setOriginalAttempt(
                            activeProfileAttempt?.parent_attempt_id
                        ...
                        {isOwnProfile && (vids as any[]).length >= 2 && (
                          <>
                            <button
                              ...
                              onClick={() => {
                                const skillId =
                                  skills.find((s: Skill) => s.name === skill)?.id ?? null
